...
Usage:
    python rmdctsc_encoder_minimal.py --input audio.wav --output audio.rmdctsc
    python rmdctsc_encoder_minimal.py --input audio.wav --output audio.rmdctsc --partials 384 --samplerate 44100
"""
import argparse
import math
import os
